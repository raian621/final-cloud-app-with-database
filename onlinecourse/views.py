...
def show_exam_result(request, course_id, submission_id):
    ...
    context = {
        'correct_choices': course.choice_set.filter(is_correct=True),
        'user_choices': choices,
        'questions': questions,
        'course': course,
        'grade': 100 * total_grade // possible_grade
    }

    print("User choices:   ", context['user_choices'])
    print("Correct choices:", context['correct_choices'])
